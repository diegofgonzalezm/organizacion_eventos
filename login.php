                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form>
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-lg btn-block btn-login"  type="button"> <a style="text-decoration:none">Iniciar sesión</a></button>
                                    </div>

                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">No tienes una cuenta? 
                                    <a class="log-i" href="form.php">Registrate aquí</a></p>
